...
"undefined" == typeof WeakMap && !function () {
    ...
    e.addModule = o, e.initializeModules = r, e.hasNative = Boolean(document.registerElement), e.useNative = !t.register && e.hasNative && !window.ShadowDOMPolyfill && (!window.HTMLImports || window.HTMLImports.useNative)
    ...
    function r(e) {
        d(e), f(e) && _(e, function (e) {
            d(e)
        })
    }

    function i(e) {
        O.push(e), N || (N = !0, setTimeout(a))
    }

    function a() {
        N = !1;
        for (var e, t = O, n = 0, o = t.length; o > n && (e = t[n]); n++)e();
        O = []
    }
    ...
    var N = !1, O = [], M = Array.prototype.forEach.call.bind(Array.prototype.forEach), L = Element.prototype.createShadowRoot;
    L && (Element.prototype.createShadowRoot = function () {
        var e = L.call(this);
        return window.CustomElements.watchShadow(this), e
    }), e.watchShadow = p, e.upgradeDocumentTree = g, e.upgradeSubtree = o, e.upgradeAll = t, e.attachedNode = r, e.takeRecords = h
}), window.CustomElements.addModule(function (e) {
    function t(t) {
    ...
    function p(e, t) {
        ...
        var o;
        return t ? (o = p(e), o.setAttribute("is", t), o) : (o = M(e), e.indexOf("-") >= 0 && _(o, HTMLElement), o)
    }
