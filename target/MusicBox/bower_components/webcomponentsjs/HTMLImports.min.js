...
"undefined" == typeof WeakMap && !function () {
    ...
    function i(e, t) {
        ...
        if (c)for (var h, m = 0; c > m && (h = s[m]); m++)a(h) ? (d++, n()) : (h.addEventListener("load", r), h.addEventListener("error", i)); else n()
    }
    ...
    var i = e.flags, a = e.IMPORT_LINK_TYPE, s = e.IMPORT_SELECTOR, d = e.rootDocument, c = e.Loader, u = e.Observer, l = e.parser, h = {
        ...
        loaded: function (e, n, r, a, s) {
            if (i.load && console.log("loaded", e, n), n.__resource = r, n.__error = a, t(n)) {
                ...
                void 0 === d && (d = a ? null : o(r, s || e), d && (d.__importLink = n, this.bootDocument(d)), this.documents[e] = d), n["import"] = d
            }
            l.parseNext()
        },
