...
window.WebComponents = window.WebComponents || {}, function (e) {
    ...
    var n = e.wrappers.DocumentFragment, r = e.TreeScope, o = e.elementFromPoint, i = e.getInnerHTML, a = e.getTreeScope, s = e.mixin, c = e.rewrap, l = e.setInnerHTML, u = e.unsafeUnwrap, d = e.unwrap, p = new WeakMap, h = new WeakMap;
    ...
    var a = e.path, s = e.rootDocument, c = e.flags, l = e.isIE, u = e.IMPORT_LINK_TYPE, d = "link[rel=" + u + "]", p = {
        documentSelectors: d,
        importsSelectors: [d, "link[rel=stylesheet]", "style", "script:not([type])", 'script[type="application/javascript"]', 'script[type="text/javascript"]'].join(","),
    ...
    function v(e) {
        e = window.wrap(e), b.dom && console.group("upgradeDocument: ", e.baseURI.split("/").pop()), t(e), w(e), b.dom && console.groupEnd()
    }
    ...
    }, HTMLImports.useNative ? t() : window.addEventListener("DOMContentLoaded", t)
}(window.WebComponents), function (e) {
    var t = document.createElement("style");
